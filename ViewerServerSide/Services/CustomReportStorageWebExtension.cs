...
using ViewerServerSide.PredefinedReports;

namespace ViewerServerSide.Services
{
    public class ReportStorageWeb : DevExpress.XtraReports.Web.Extensions.ReportStorageWebExtension
    {
        readonly string ReportDirectory;
        const string FileExtension = ".repx";
        public ReportStorageWeb(IHostingEnvironment env) {
